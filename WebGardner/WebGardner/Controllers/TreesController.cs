...
namespace WebGardner.Controllers
{
    ...
    public class TreesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TreeId,SortName,Amount,LocationId")] Tree tree)
        {
            ...
            ViewData["LocationId"] = new SelectList(_context.Locations, "LocationId", "LocationId", tree.LocationId);
            return View(tree);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TreeId,SortName,Amount,LocationId")] Tree tree)
        {
            if (id != tree.TreeId)
            {
                return NotFound();
        ...
        {
            return _context.Trees.Any(e => e.TreeId == id);
        }
    }
}
